...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, MOTOR_ROLLER_DIR_Pin|MOTOR_RIGHT_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MOTOR_LEFT_DIR_GPIO_Port, MOTOR_LEFT_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : MOTOR_ROLLER_DIR_Pin MOTOR_RIGHT_DIR_Pin */
  GPIO_InitStruct.Pin = MOTOR_ROLLER_DIR_Pin|MOTOR_RIGHT_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : MOTOR_LEFT_DIR_Pin */
